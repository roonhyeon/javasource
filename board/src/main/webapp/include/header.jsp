			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href='<c:url value="/writeForm.jsp"/>'>게시글 작성</a></li> <!-- set 페이지가 그냥 list.jsp로 잘못 지정되어서 null point가 떴다. getAttribute가 있는 페이지로 경로를 설정하면 안된다. -->
