...
public class MemberUi {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (menu) {
			case 1:
				member=util.getNewMember(sc); //리턴값 member를 list에 추가
				list.add(member);
				util.printAddSucessMessage(member);
				break;
            case 2:
            ...
            case 3:
				...
				if (member!=null) {
					util.printUpdateSucessMessage(member);
				}else {
            ...
            case 4:
	            ...
	            if (member!=null) {
					util.printRemoveSucessMessage(member);
				}else {
