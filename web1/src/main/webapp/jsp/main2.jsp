...
<body>
    <%-- 
         ...
         3. PageContext pageContext: 다른 내장 객체에 접근할 수 있는 권한
            pageContext.include(): include 지시어가 하는 역할
         4. HttpSession session;: 세션을 다루는 객체
         5. ServletContext application;: 웹 어플리케이션의 실행 환경을 제공하는 서버측 정보, 서버측 자원에 해당하는 정보를 다룰 수 있는 객체
         6. JspWriter out;: 자바코드로 화면 출력하기
